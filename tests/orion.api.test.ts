...
const globalUserId = 'GE3DQMRZHE4UAU2ZKNPUC';
...
async function createSHL(userId: string, config: types.HealthLinkConfig = {}) {
  ...
  assertions.assertEquals(shlink.indexOf('shlink:/'), 0);
  ...
  return shlink as types.SHLDecoded;
}

async function updateUserShls(userId: string) {
  const shlsResponse = await fetch(`${baseUrl}/api/user`, {
    method: 'POST',
    headers: {
      'content-type': 'application/json',
    },
...
async function addSHCFile(userId:string, shlid?:string) {
  ...
  const shlFileResponse = await fetch(`${baseUrl}/api/shl/${shl!.id}/file`, {
    method: 'POST',
    headers: {
...
async function getManifest(id: string, body: types.HealthLinkManifestRequest) {
  const manifestResponse = await fetch(`${baseUrl}/api/shl/${id}`, {
    method: 'POST',
    headers: {
      'content-type': 'application/json',
    },
...
Deno.test({
  name: 'Create SHL',
  async fn(t) {
    const userId = globalUserId ?? randomStringWithEntropy(32);
...
//       const sseTicketRequest = await fetch(`${baseUrl}/api/subscribe`, {
//         method: 'POST',
//         headers: {
//           authorization: `Bearer ${shl.managementToken}`,
//         },
...
//       const putResponse = await fetch(`${baseUrl}/api/shl/${shl!.id}`, {
//         method: 'PUT',
//         headers: {
//           'content-type': 'application/json',
//           authorization: `Bearer ${shl.managementToken}`,
...
//       const putResponse = await fetch(`${baseUrl}/api/shl/nonexistent-shl-id`, {
//         method: 'PUT',
//         headers: {
//           'content-type': 'application/json',
//           authorization: `Bearer ${shl.managementToken}`,
...
//       const activeResponse = await fetch(`${baseUrl}/api/shl/${shl!.id}/active`, {
//         method: 'GET',
//         headers: {
//           'content-type': 'application/json',
//         },
...
//       const deactivateResponse = await fetch(`${baseUrl}/api/shl/${shl!.id}`, {
//         method: 'DELETE',
//         headers: {
//           'content-type': 'application/json',
//           authorization: `Bearer ${shl.managementToken}`,
...
//       const manifestResponse = await fetch(`${baseUrl}/api/shl/${shl!.id}`, {
//         method: 'POST',
//         headers: {
//           'content-type': 'application/json',
//         },
...
//       const activateResponse = await fetch(`${baseUrl}/api/shl/${shl!.id}/reactivate`, {
//         method: 'PUT',
//         headers: {
//           'content-type': 'application/json',
//           authorization: `Bearer ${shl.managementToken}`,
...
//       const deactivateResponse = await fetch(`${baseUrl}/api/shl/nonexistent-shl-id`, {
//         method: 'DELETE',
//         headers: {
//           'content-type': 'application/json',
//           authorization: `Bearer ${shl.managementToken}`,
...
//       const activateResponse = await fetch(`${baseUrl}/api/shl/nonexistent-shl-id/reactivate`, {
//         method: 'PUT',
//         headers: {
//           'content-type': 'application/json',
//           authorization: `Bearer ${shl.managementToken}`,
...
//       const deleteResponse = await fetch(`${baseUrl}/api/shl/${shl!.id}/file`, {
//         method: 'DELETE',
//         headers: {
//           'content-type': 'application/json',
//           authorization: `Bearer ${shl.managementToken}`,
...
//       const shlFileResponse = await fetch(`${baseUrl}/api/shl/nonexistent-shl/file`, {
//         method: 'POST',
//         headers: {
//           'content-type': 'application/fhir+json',
//           authorization: `Bearer ${shl.managementToken}`,
...
//       const deleteResponse = await fetch(`${baseUrl}/api/shl/nonexistent-shl/file`, {
//         method: 'DELETE',
//         headers: {
//           'content-type': 'application/json',
//           authorization: `Bearer ${shl.managementToken}`,
...
//     await t.step('Create a SHL', async function () {
//       const shlResponse = await fetch(`${baseUrl}/api/shl`, {
//         method: 'POST',
//         headers: {
//           'content-type': 'application/json',
//         },
...
//       const shlFileResponse = await fetch(`${baseUrl}/api/shl/${shl!.id}/endpoint`, {
//         method: 'POST',
//         headers: {
//           'content-type': 'application/json',
//           authorization: `Bearer ${shl.managementToken}`,
